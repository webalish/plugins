...
namespace Alishplugins\Modules;
...
use Alishplugins\Modules\Exceptions\InvalidAssetPath;
use Alishplugins\Modules\Exceptions\ModuleNotFoundException;
use Alishplugins\Modules\Process\Installer;
use Alishplugins\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param string $args
     * @param string $path
     * @return \Alishplugins\Modules\Module
     */
     ...
     * @return string
     * @throws \Alishplugins\Modules\Exceptions\ModuleNotFoundException
     */
